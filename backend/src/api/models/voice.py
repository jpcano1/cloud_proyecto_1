...
class Voice(db.Model):
    ...
    raw_audio = db.Column(db.String(255), default="")
    converted_audio = db.Column(db.String(255), default="")
...
class VoiceSchema(ModelSchema):
    ...
    raw_audio = fields.String(dump_only=True)
    converted_audio = fields.String(dump_only=True)
